                    ...
                    if GPIO.input(row[i])==0:
                        ...
                        if(i==0 and j==3):                  # Key: A
                            ...
                            if keyid==pin:
                                ...
                                print 'Voice added to database, moving to finger enrollment...'
                                time.sleep(2)
                                result=fingerCode.enroll(keyid)
                                ...
                                print 'Fingerprint added to database, moving to Barcode enrollment...'
                                barCode.enroll(keyid)
                            else:
                            ...
                            if keyid==pin:
                                ...
                                if result=='Key Not Present':
                                    ...
                                    if result=='Key Not Present':
                                        ...
                                        print'Initializing fingerprint deletion...'
                                        time.sleep(1)
                                        result=fingerCode.delete(keyid)
                                        if result=='Key Not Present':
                                            print 'Invalid Key Entered'
                                        else:
                                            print'Initializing Barcode deletion...'
                                            time.sleep(1)
                                            result=barCode.delete(keyid)
                                            if result=='Key Not Present':
                                                print 'Invalid Key Entered'
                                countEntered=0
                            else:
                            ...
                            if result1=='Not Found':
                                ...
                                time.sleep(2)
                                result2=voiceCode.recog('FaceVoiceModule')
                                ...
                                if result2=='Not Found':
                                    ...
                                    if result1 == result2:
                                        print 'Voice Recognised. Initialising Finger recognition!'
                                        result3=fingerCode.search()
                                        while(result3=='Not Accurate'):
                                            print 'Not Very Accurate! Please try again!'
                                            result3=fingerCode.search()
                                        if result3=='Sensor Error':
                                            print 'The Sensor is not working properly. Please contact the service personnel. Sorry for the inconvinience!'
                                        elif result3=='Unknown Error':
                                            print 'Some unknown error occured. Please contact the service personnel. Sorry for the inconvinience!'
                                        elif result3=='Not Found':
                                            buzzer.passRejected()
                                            print 'Fingerprint not recognised!'
                                        else:
                                            if result3==result2:
                                                print 'Fingerprint recognised! Initializing barcode recognition...'
                                                result4=barCode.recog()
                                                if result4=='Not Found':
                                                    print 'Barcode not recognised!'
                                                    buzzer.passRejected()
                                                else:
                                                    if result4==result3:
                                                        ...
                                                        print 'Recognised users for the modules are not the same !'
                                            else:
                                                print 'Recognised users for the modules are not the same !'
                                    else:
