                    ...
                    if GPIO.input(row[i])==0:
                        ...
                        if(i==0 and j==3):                  # Key: A
                            ...
                            if keyid==pin:
                                ...
                                keyid=''.join(keyid)
                                barCode.train(keyid)
                                print 'Barcode added to data, moving to fingerprint enrollment!'
                            ...
                            #print "Recognise"
                            print 'Initializing barcode recognition...'
                            result1=barCode.recog()
                            if result1=='No Data':
                                print 'No data available for recognition!'
                            if result1=='Not Found':
                                print 'Barcode not recognised!'
                                buzzer.passRejected()
                            else:
                                print 'Barcode Recognised. Initialising fingerprint recognition...'
                                result2=fingerCode.search()
                                while(result2=='Not Accurate'):
                                    print 'Not Very Accurate! Please try again!'
                                    result2=fingerCode.search()
                                if result2=='No Data':
                                    print 'No data available for recognition!'
                                if result2=='Sensor Error':
                                    print 'The Sensor is not working properly. Please contact the service personnel. Sorry for the inconvinience!'
                                elif result2=='Unknown Error':
                                    print 'Some unknown error occured. Please contact the service personnel. Sorry for the inconvinience!'
                                    ...
                                    if result1==result2:
                                        ...
                                        print 'Users of Barcode and Fingerprint recognition do not match!'
                            countEntered=0
